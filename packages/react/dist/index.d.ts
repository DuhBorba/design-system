...
interface HeadingProps extends ComponentProps<typeof Text> {
    as?: ElementType;
}
...
interface TextProps extends ComponentProps<typeof Heading> {
    as?: ElementType;
}
...
declare const Tooltip: {
    ({ content, children, ...props }: TooltipProps): react_jsx_runtime.JSX.Element;
    displayName: string;
};
...
declare const Toast: {
    ({ title, description, ...props }: ToastProps): react_jsx_runtime.JSX.Element;
    displayName: string;
};
